              ...
              <div className="mt-4 grid grid-cols-1 gap-3">
                {!pinCode ? (
                  ...
                  <>
                    ...
                    >
                      <div className="font-['Playfair_Display',serif] italic font-bold text-[16px] text-[#5a2d42]">
                        {t.changePin}
                      </div>
            ...
            <AnimatePresence>
              {showPinOptions && (
                ...
                >
                  {mode !== "create" && (
                    <div>
                      <div className="font-['Cormorant_Garamond',serif] italic text-[14px] text-[color:var(--text-light)] mb-2">
                        {t.enterCurrentPin}
                      </div>
                      <input
                        type="password"
          ...
          {session.inboxId && (
            <div className="rounded-[18px] bg-white/55 border border-white/60 shadow-[0_10px_30px_rgba(180,90,130,.12)] px-5 py-4">
              ...
              <div className="mt-4 rounded-[16px] bg-white/55 border border-white/60 px-4 py-3">
                <div className="font-['Cormorant_Garamond',serif] italic text-[13px] text-[color:var(--text-light)]">
                  {t.currentInbox}
                </div>
                <div className="mt-1 font-mono text-[12px] text-[#6c5060] break-all">
                  {session.inboxId}
                </div>
              </div>
