export const dictionaries = {
    en: {
        ...
        homeWelcomeTitle: "Welcome to Secret Valentine.",
        homeWelcomeBody: "Reveal your heart, keep your mystery. Send a message to the one you love, without them knowing it’s you… yet.",
        homeCheckLetters: "Check your received letter",
        homeWriteMessage: "Write your message",
        loveLettersTitle: "Your Love Letters",
        loveLettersSubtitle: "You have {n} secret messages waiting for you",
        composeYourLetter: "Compose your letter",
        composeSubtitle: "Write a heartfelt message to someone special",
        sendLetter: "Send Letter",
        sendAnon: "Send anonymously",
        close: "Close",
        reply: "Reply",
        invalidLink: "This link is invalid, expired, or already used.",
        pinHelp: "PIN lock protects your inbox. You can change/remove it after unlocking.",
    ...
    fr: {
        ...
        homeWelcomeTitle: "Bienvenue sur Secret Valentine.",
        homeWelcomeBody: "Révèle ton cœur, garde ton mystère. Envoie un message à la personne que tu aimes, sans qu’elle sache que c’est toi… pour l’instant.",
        homeCheckLetters: "Voir mes lettres",
        homeWriteMessage: "Écrire un message",
        loveLettersTitle: "Tes lettres d’amour",
        loveLettersSubtitle: "Tu as {n} messages secrets qui t’attendent",
        composeYourLetter: "Écris ta lettre",
        composeSubtitle: "Écris un message sincère à quelqu’un de spécial",
        sendLetter: "Envoyer la lettre",
        sendAnon: "Envoyer anonymement",
        close: "Fermer",
        reply: "Répondre",
        invalidLink: "Ce lien est invalide, expiré ou déjà utilisé.",
        pinHelp: "Le verrou PIN protège ta boîte. Tu peux le changer/retirer après déverrouillage.",
